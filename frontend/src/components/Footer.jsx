...
const Footer = () => {
  return <footer className="bg-primary  dark:bg-gray-900">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
                    
                    <span className="self-center text-2xl font-normal whitespace-nowrap text-white font-concertOne">Tinder Clone</span>
